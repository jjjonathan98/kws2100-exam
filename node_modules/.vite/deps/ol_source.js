...
import "./chunk-WDR3CECU.js";
import "./chunk-E2DEB53D.js";
import {
  Feature_default
...
import "./chunk-LZOII23L.js";
import {
  assert
} from "./chunk-QFCIXVZ3.js";
import "./chunk-E2ENBALP.js";
import {
  Disposable_default,
  Event_default,
  listen,
      ...
      for (let reproj = reprojs - 1; reproj >= 0; --reproj) {
        ...
        for (let i = 0, len = dataSources.length; i < len; ++i) {
          ...
          for (let j = 0, len2 = data2.length; j < len2; j += 4) {
            data2[j] = buffer3[offset2];
            data2[j + 1] = buffer3[offset2 + 1];
            data2[j + 2] = buffer3[offset2 + 2];
            data2[j + 3] = 255;
